...
const TECHS = [
  ...
  {id:'tactics',name:'联合作战学',icon:'🎯',era:1,time:2.1,cost:28,pre:['mining'],desc:'解锁弓手、骑士与混编阵线加成。',unlock:['archer','knight']},
...
const UNIT_DEFS = {
  ...
  archer:{name:'长弓手',icon:'🏹',role:'远程',hp:125,attack:25,range:3,interval:.78,move:1.05,cost:{food:14,production:26,gold:12},time:2.2,tech:'tactics',combat:true,desc:'三格射程，适合在混编阵线后方持续输出。'},
